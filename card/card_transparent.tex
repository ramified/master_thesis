...
\def\borderlinewholewidth{\borderlinewidth *2 + \borderlinewhitewidth}
    \foreach \x/\xcolor in {0/white,1/white,2/white,3/white}
    {
...
%    https://tex.stackexchange.com/questions/641843/plot-difference-of-sets-in-tikz
%\fill[even odd rule] (PosF00) circle (1) (PosF10) circle (1);
