...
\begin{array}{|c|c|c|c|}
\hline
      & \Gape[0cm][2mm]{\pt}         & \mathcal{F}                                                    & \mathcal{F} \otimes \mathcal{F}                                         \\
       \hline
\GL_n & \Rpt(T)^{W} & \Rpt(T)                                                        & \displaystyle\bigoplus_{w'} \Rpt(T)  \left[ \overline{\OOmcell}_{w'} \right]^{\GL_n} \\ \hline
B     & \Rpt(T)     & \displaystyle\bigoplus_{w} \Rpt(T) \left[ \overline{\Omcell}_{w} \right]^B  & \displaystyle\bigoplus_{w,w'} \Rpt(T) \left[ \overline{\OOmcell}_{w,w'} \right]^B    \\ \hline
\Id   & \mathbb{Z}  & \displaystyle\bigoplus_{w} \mathbb{Z} \left[ \overline{\Omcell}_{w} \right] & \displaystyle\bigoplus_{w,w'} \mathbb{Z} \left[ \overline{\OOmcell}_{w,w'} \right]   \\ \hline
\end{array}
\]
\end{table}
