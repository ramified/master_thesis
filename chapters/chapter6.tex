...
\begin{defn}[Incidence variety for strict flags]\label{def:incidence_variety_str}\index{incidence variety!for strict flag}
...
\begin{table}[ht]
  \vspace{0cm}
    \centering  \includegraphics[width=12cm]{figures/table/table_euler_class_q.pdf}
      \caption[Lie algebras and corresponding Euler classes, $G_{\dimvec{d}}\times \mathbb{C}^{\times}$-action]{}
...
\end{theorem}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{From formula to diagram}\label{sec:diagram}\index{diagram of strands}
...
\begin{figure}[ht]
  \vspace{0cm}
    \centering  \includegraphics[width=12cm]{figures/strands/generators.pdf}
      \caption[Generators of the $K$-theory  $K^{G_{\dimvec{d}}}(\St_{\dimvec{d}})$]{}
...
\end{proof}
Lemma \ref{lem:convolution_product_1} explains ``what happens when a point walk through a crossing". The convolution algebra $H_{G_{\dimvec{d}}}^{*}(\St_{\dimvec{d}})$ is called the \textbf{KLR algebra}\index{KLR algebra}. The relations of the KLR algebra can be found in \cite[Definition 3.2.2]{seiffarth2017klr}, and we will only show the relations of $K$-theoretic version.
\begin{warning}
...
In this case, $K^{G_{\dimvec{d}}} (\mathcal{F}_{\dimvec{d}} \times  \mathcal{F}_{\dimvec{d}})$ is called the \textbf{$\boldsymbol{K}$-theoretic NilHecke algebra}, and $H_{G_{\dimvec{d}}}^{*}(\mathcal{F}_{\dimvec{d}} \times  \mathcal{F}_{\dimvec{d}})$ is called the \textbf{(cohomological) NilHecke algebra}.\index{NilHecke algebra}
...
\begin{figure}[ht]
  \vspace{0cm}
    ...
    \caption[Relations of $K$-theoretic KLR algebra, I]{}
...
\begin{figure}[ht]
  \vspace{0cm}
    ...
    \caption[Relations of $K$-theoretic KLR algebra, II]{}
...
as the augmentation ideals\index{augmentation ideal} in $\Rpt(G)$ and $\Spt(G)$, respectively. We define
...
\begin{theorem}[Atiyah--Segal completion theorem]\label{thm:Atiyah--Segal_completion_theorem}\index{Atiyah--Segal completion theorem}
...
is an isomorphism, and the (cohomology) Chern class map\index{Characteristic class!Chern class} (defined in \cite[5.8]{chriss1997representation})
...
As a quotient of two (different types of) Euler class, the \textbf{Todd class}\index{Characteristic class!Todd class}
