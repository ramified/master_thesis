...
$\ftdimvec{d}$ is called a complete flag-type dimension vector if $\ftdimvec{d}$ is the dimension vector of some complete flag $F$, i.e.,\footnote{For convenience, we denote $M_0$ by 0.} $d=\abdimvec{d}$ and
...
\subsection{Stratification: incidence variety}\label{subsec:stratification:_incidence_variety}
