...
by the collection of all partial flags of length $d$, and call it the partial flag variety associated to $X$. 
\end{defn}
...
by the collection of all strict partial flags of length $d$, and call it the strict partial flag variety associated to $X$. 
\end{defn}
...
Given two indecomposable representations $T,T' \in \Mod(R)$, let
\begin{equation*}
\begin{aligned}
