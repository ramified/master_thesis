...
\begin{figure}[!ht]
  \vspace{0cm}
    \centering  \[\begin{tikzcd}[row sep=5mm, scale=0.7]
...
\begin{proof}\belowdisplayskip=-12pt
	...
	and the information of non-vertical arrows in the extended quiver (see Example \ref{eg:ext_quiver}) just reduce the number of $\mathbb{P}^1$. 
\end{proof}
...
%https://tex.stackexchange.com/questions/233481/subcaption-defaulting-to-capital-letter-labels
		...
		\centering
			...
			\includegraphics[width=28mm]{figures/affine_paving/E8graypic1.pdf}
			\subcaption{}
			}
			\parbox[b]{.23\textwidth}{\centering
			\includegraphics[width=28mm]{figures/affine_paving/E8graypic2.pdf}
			\subcaption{}
			}
			\parbox[b]{.23\textwidth}{\centering
			\includegraphics[width=28mm]{figures/affine_paving/E8graypic3.pdf}
			\subcaption{}
			}
			\parbox[b]{.23\textwidth}{\centering
			\includegraphics[width=28mm]{figures/affine_paving/E8graypic4.pdf}
			\subcaption{}
			}
