...
$$B_{\ww}= \ww \absgp{B}_{\abdimvec{d}} \cap B_{\dimvec{d}}=wB_{\dimvec{d}}w^{-1}$$
...
\paragraph*{\underline{Step1}}Setting.
...
\paragraph*{\underline{Step2}}Convolution product on the level of varieties.

For closed $G$-subvarieties $Z_{12} \subseteq M_{12}$, $Z_{23} \subseteq M_{23}$, denote
$$Z_{123}:= p_{12}^{-1}(Z_{12}) \cap p_{23}^{-1}(Z_{23}) \subseteq M_123$$
...
\paragraph*{\underline{Step3}}Convolution product on the level of $K$-theories.
