...
Closures of $\OOcell$-cells are obtained by identifications (\ref{eq:identification}). To illustrate it, we compute $\overline{\OOcell}_s$ by hand. Let $\ww'=s, us=\tilde{w}\tilde{u}$,
...
We end this subsection by Table ???:
...
\end{defn}
\section[Basic constructions]{Basic constructions: pullback, proper pushforward and tensor product}
\subsection{pullback}
