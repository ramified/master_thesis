...
Now wee understand a lot about $\mathcal{F}$ and $\mathcal{F} \times \mathcal{F}$, and the whole process of analysis(investigations?) will be applied repeatedly in section ???. 
\section{Quiver}
...
\section{Basic constructions: pullbask, pushforward and tensor product}
\section{Induction}
\section{Reduction}
