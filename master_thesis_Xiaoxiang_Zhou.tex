...
The following tables conclude the results in this section.
...
\begin{aligned}
  ...
  \cong\;& \bigoplus_{w'} \Rpt(B)  \left[ \overline{\OOmcell}_{w'} \right]^B
\end{aligned}
\end{equation*}
\end{eg}
...
$$\Rpt(N_{\dimvec{d}}) \cong \Rpt(\Id) \cong \mathbb{Z} \qquad \Rpt(B_{\dimvec{d}}) \cong \Rpt(T_{\dimvec{d}}) \cong \mathbb{Z}\!\left[ \varepsilon_1^{\pm 1},\ldots,\varepsilon_{\abdimvec{d}}^{\pm 1} \right]$$
$$ \Rpt(G_{\dimvec{d}}) \cong \Rpt(T_{\dimvec{d}})^{\Wd} \cong \mathbb{Z}\!\left[ \varepsilon_1^{\pm 1},\ldots,\varepsilon_{\abdimvec{d}}^{\pm 1} \right]^{\Wd}$$
\end{eg}
