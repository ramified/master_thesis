...
W_{\dimvec{d}} = S_3 \times S_2      & w                                   &     w_{\max}= \raisebox{-3mm}{\permutation[tkzpic=1,type=0,scale=0.5]{3,2,1,5,4}}                                        &  \Pi_{\dimvec{d}}=\{s_1,s_2,\phantom{s_3,}s_4 \}              \\ \hline
...
\begin{aligned}
  ...
  \OOmcell_{w,w'}^{u,u'}=\;& \left(B_{\dimvec{d}} \times B_{\dimvec{d}}\right) / \left(B_{\dimvec{d}} \cap B_{w} \times B_{\dimvec{d}} \cap B_{w'}\right)&& \cong \mathbb{A}^{l(w)+l(w')}  \\ 
  \OOmcell_{w'}^{u,u'}=\;& G_{\dimvec{d}} /\left(  B_{\dimvec{d}} \cap B_{w'} \right) && \cong \mathbb{A}^{l(w')}\text{-bundle over }\mathcal{F}_{u}  \\ 
\end{aligned}
\end{equation*}
...
\begin{aligned}
  ...
  \preimage{\OOcell}_{\ww'}^{u}:=\;& \pi_{\ftdimvec{d},\widetilde{\ftdimvec{d}}}^{-1}(\OOcell_{\ww'}^{u}) = \preimage{\OOmcell}_{\tilde{w}}^{u,\tilde{u}}\hspace{2cm}&& \subseteq \St_{\ftdimvec{d},\widetilde{\ftdimvec{d}}}  \\[3mm]
...
\begin{aligned}
  ...
  \RRep_{\dimvec{d}}(Q)=\;& \bigsqcup_{\ww} \preimage{\Ocell}_{\ww} \qquad &  \St_{\ftdimvec{d},\ftdimvec{d}'} =\;& \bigsqcup_{\ww'} \preimage{\OOcell}_{\ww'} = \bigsqcup_{\ww,\ww'} \preimage{\OOcell}_{\ww,\ww'}  \\
\end{aligned}
\end{equation*}
...
\[\begin{tikzcd}[column sep=huge]
	{G \times X \times X} & {G \times X} & X
	\arrow["\alpha", shift left=3, from=1-2, to=1-3]
	\arrow["{p_3^{23}=p_3^{13}}", shift right=3, from=1-2, to=1-3]
	\arrow["{\Id_G \times \alpha}", from=1-1, to=1-2]
	\arrow["{m \times \Id_X}", shift left=6, from=1-1, to=1-2]
	\arrow["{p_{23}}", shift right=6, from=1-1, to=1-2]
\end{tikzcd}\]
...
$$\phi_{\mathcal{F}}:\alpha^* \mathcal{F} \longrightarrow p_3^{23,*} \mathcal{F}$$
...
\[\begin{tikzcd}[column sep={2cm,between origins}]
	& {(m \times \Id_X)^* \alpha^* \mathcal{F}} &[3.5cm] {(m \times \Id_X)^* p_3^{23,*} \mathcal{F}} &\\
	{(\Id_G \times \alpha)^* \alpha^* \mathcal{F}} &&& {p_{23}^*p_3^{23,*} \mathcal{F}} \\
	& {(\Id_G \times \alpha)^* p_3^{23,*} \mathcal{F}} & {p_{23}^* \alpha^* \mathcal{F}}
	...
	\arrow["{p_{23}^*\phi_{\mathcal{F}}}", from=3-3, to=2-4]
	\arrow["{(\Id_G \times \alpha)^* \phi_{\mathcal{F}}}", from=2-1, to=3-2]
\end{tikzcd}\]
