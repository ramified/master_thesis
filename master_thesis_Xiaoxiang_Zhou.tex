...
\hline
              & \Omcell_{\Id}      & \Omcell_{t}      & \Omcell_{s}      & \Omcell_{ts}      & \Omcell_{st}      & \Omcell_{sts}      \\ \hline
\Omcell_{\Id} & \OOmcell_{\Id,\Id} & \OOmcell_{\Id,t} & \OOmcell_{\Id,s} & \OOmcell_{\Id,ts} & \OOmcell_{\Id,st} & \OOmcell_{\Id,sts} \\ \hline
\Omcell_{t} & \OOmcell_{t,t}   & \OOmcell_{t,\Id}   & \OOmcell_{t,ts}   & \OOmcell_{t,s}   & \OOmcell_{t,sts}   & \OOmcell_{t,st}   \\ \hline
\Omcell_{s} & \OOmcell_{s,s}   & \OOmcell_{s,st}   & \OOmcell_{s,\Id}   & \OOmcell_{s,sts}   & \OOmcell_{s,t}   & \OOmcell_{s,ts}   \\ \hline
\Omcell_{ts} & \OOmcell_{ts,st}  & \OOmcell_{ts,s}  & \OOmcell_{ts,sts}  & \OOmcell_{ts,\Id}  & \OOmcell_{ts,ts}  & \OOmcell_{ts,t}  \\ \hline
\Omcell_{st}  & \OOmcell_{st,ts}  & \OOmcell_{st,sts}  & \OOmcell_{st,t} & \OOmcell_{st,st}  & \OOmcell_{st,\Id}  & \OOmcell_{st,s}  \\ \hline
\Omcell_{sts} & \OOmcell_{sts,sts} & \OOmcell_{sts,ts} & \OOmcell_{sts,st} & \OOmcell_{sts,t} & \OOmcell_{sts,s} & \OOmcell_{sts,\Id} \\ \hline
\end{array}
\]
}
\end{table}
