...
%\begin{figure}[ht]
%  \vspace{0cm}
%    \centering  \includegraphics[width=12cm]{figures/temporary/BB_orbits_FF.jpg}
%      \label{fig:stratifications_of_FF}
%        \caption{stratifications of $\mathcal{F}\times \mathcal{F}$}
%        
%\end{figure}

%\hspace{2mm}\diaghead(1,-1){\theadfont $B_{\dimvec{d}} \cdot F_{ww'}$}%
%       {$B_{\dimvec{d}} \cdot F_{w}$}{$B_{\dimvec{d}} \cdot F_{ww'}$} \hspace{10mm}
...
\hline \hbox{\diagbox[innerwidth=30mm,height=3\normalbaselineskip,outerleftsep=0pt,outerrightsep=0pt,innerleftsep=1pt,innerrightsep=1pt]{$\scriptstyle B_{\dimvec{d}} \cdot F_{w}$ }{\textcolor{red}{$\scriptstyle\dim$} \\ $\hspace{0.5cm}\scriptstyle(B \times B) \cdot \underline{F}_{w,w'}$\hspace{-8mm}\vspace{-2mm} }{$\scriptstyle B_{\dimvec{d}} \cdot F_{ww'}$}}
...
\inCell{0}{\Omcell_{\Id}} & \inCell{0}{\OOmcell_{\Id,\Id}} & \inCell{1}{\OOmcell_{\Id,t}} & \inCell{1}{\OOmcell_{\Id,s}} & \inCell{2}{\OOmcell_{\Id,ts}} & \inCell{2}{\OOmcell_{\Id,st}} & \inCell{3}{\OOmcell_{\Id,sts}} \\ \hline
\inCell{1}{\Omcell_{t}} & \inCell{2}{\OOmcell_{t,t}}   & \inCell{1}{\OOmcell_{t,\Id}}   & \inCell{3}{\OOmcell_{t,ts}}   & \inCell{2}{\OOmcell_{t,s}}   & \inCell{4}{\OOmcell_{t,sts}}   & \inCell{3}{\OOmcell_{t,st}}   \\ \hline
\inCell{1}{\Omcell_{s}} & \inCell{2}{\OOmcell_{s,s}}   & \inCell{3}{\OOmcell_{s,st}}   & \inCell{1}{\OOmcell_{s,\Id}}   & \inCell{4}{\OOmcell_{s,sts}}   & \inCell{2}{\OOmcell_{s,t}}   & \inCell{3}{\OOmcell_{s,ts}}   \\ \hline
\inCell{2}{\Omcell_{ts}} & \inCell{4}{\OOmcell_{ts,st}}  & \inCell{3}{\OOmcell_{ts,s}}  & \inCell{5}{\OOmcell_{ts,sts}}  & \inCell{2}{\OOmcell_{ts,\Id}}  & \inCell{4}{\OOmcell_{ts,ts}}  & \inCell{3}{\OOmcell_{ts,t}}  \\ \hline
\inCell{2}{\Omcell_{st}}  & \inCell{4}{\OOmcell_{st,ts}}  & \inCell{5}{\OOmcell_{st,sts}}  & \inCell{3}{\OOmcell_{st,t}} & \inCell{4}{\OOmcell_{st,st}}  & \inCell{2}{\OOmcell_{st,\Id}}  & \inCell{3}{\OOmcell_{st,s}}  \\ \hline
\inCell{3}{\Omcell_{sts}} & \inCell{6}{\OOmcell_{sts,sts}} & \inCell{5}{\OOmcell_{sts,ts}} & \inCell{5}{\OOmcell_{sts,st}} & \inCell{4}{\OOmcell_{sts,t}} & \inCell{4}{\OOmcell_{sts,s}} & \inCell{3}{\OOmcell_{sts,\Id}} \\ \hline
\end{array}
\]
}
