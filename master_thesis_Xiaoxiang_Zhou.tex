...
\end{tikzcd}\]
By definition, we get $$p_{3,X}^{23} \circ \Id_G \times f = f \circ p_{3,Y}^{23}.$$ 
Since $f$ is $G$-equivariant, $$\alpha_X \circ \Id_G \times f = f \circ \alpha_Y.$$
...
内容...
\end{proposition}
For a proof, see \cite[Theorem 5.4.17].
\section{Induction}
