...
\blockzero{0} && \blockzero{0} && \blockzero{1} && \blockzero{1} && \blockzero{0} && \blockzero{0} && \blockzero{0} \\
\blockzero{0} & \blockzero{0} & \blockzero{0} & \blockzero{1} & \blockzero{1} & \blockzero{2} & \blockzero{1} & \blockzero{1} & \blockzero{0} & \blockzero{0} & \blockzero{0} & \blockzero{0} & \blockzero{0} \\
\blockzero{0} && \blockzero{0} && \blockzero{1} && \blockzero{1} && \blockzero{0} && \blockzero{0} && \blockzero{0}
...
\node [black] at (recCen0) {
$\begin{tikzcd}[sep={between origins, \betweenpieces}]
\blockone{0} && \blockone{0} && \blockone{1} && \blockone{0} && \blockone{1} && \blockone{0} && \blockone{0} \\
\blockone{0} & \blockone{0} & \blockone{0} & \blockone{0} & \blockone{0} & \blockone{1} & \blockone{1} & \blockone{1} & \blockone{0} & \blockone{0} & \blockone{0} & \blockone{0} & \blockone{0} \\
\blockone{0} && \blockone{0} && \blockone{0} && \blockone{1} && \blockone{0} && \blockone{0} && \blockone{0}
\arrow[from=2-3, to=2-4]
\arrow[from=1-1, to=2-2]
\arrow[from=2-1, to=2-2]
\arrow[from=3-1, to=2-2]
