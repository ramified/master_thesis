...
\def\borderlinewholewidth{\borderlinewidth *2 + \borderlinewhitewidth}
    \foreach \x/\xcolor in {0/red,1/orange,2/yellow,3/green}
    {
    ...
    \draw (PosA\x) [line width=0mm,black,rounded corners=\cornerradius]rectangle (PosD\x) node(recCen\x)[midway] {};

%    \draw[line width=\borderlinewholewidth,rounded corners=\cornerradius]
%    (PosC0) ++(36mm+ 2 * \x * \betweenpieces ,0) --++(\cornerradius,0)-- ++(0,-\extraheight) --++(2 * \betweenpieces,0) -- ++(0,\extraheight) --++(\cornerradius,0);
...
%        (PosC0) ++(36mm+ 2 * \x * \betweenpieces ,0) --++(\cornerradius,0)-- ++(0,-\extraheight) --++(\betweenpieces,0)node(PosE\x)[yshift=\extraheight/2,black] {}--++(\betweenpieces,0) -- ++(0,\extraheight) --++(\cornerradius,0);
%    
...
\node [black] at (recCen0) {
$\begin{tikzcd}[sep={between origins, \betweenpieces}]
\phantom{\blockzero{0}} && \phantom{\blockzero{0}} && \blockzero{1} && \blockzero{1} && \blockzero{0} && \phantom{\blockzero{0}} && \phantom{\blockzero{0}} \\
\phantom{\blockzero{0}} & \phantom{\blockzero{0}} & \phantom{\blockzero{0}} & \blockzero{1} & \blockzero{1} & \blockzero{2} & \blockzero{1} & \blockzero{1} & \blockzero{0} & \phantom{\blockzero{0}} & \phantom{\blockzero{0}} & \phantom{\blockzero{0}} & \phantom{\blockzero{0}} \\
\phantom{\blockzero{0}} && \phantom{\blockzero{0}} && \blockzero{1} && \blockzero{1} && \blockzero{0} && \phantom{\blockzero{0}} && \phantom{\blockzero{0}}
...
\node [black] at (recCen0) {
$\begin{tikzcd}[sep={between origins, \betweenpieces}]
\phantom{\blockone{0}} && \phantom{\blockone{0}} && \blockone{1} && \blockone{0} && \blockone{1} && \phantom{\blockone{0}} && \phantom{\blockone{0}} \\
\phantom{\blockone{0}} & \phantom{\blockone{0}} & \phantom{\blockone{0}} & \blockone{0} & \blockone{0} & \blockone{1} & \blockone{1} & \blockone{1} & \blockone{0} & \phantom{\blockone{0}} & \phantom{\blockone{0}} & \phantom{\blockone{0}} & \phantom{\blockone{0}} \\
\phantom{\blockone{0}} && \phantom{\blockone{0}} && \blockone{0} && \blockone{1} && \blockone{0} && \phantom{\blockone{0}} && \phantom{\blockone{0}}
%%\arrow[from=2-3, to=2-4]
%%\arrow[from=1-1, to=2-2]
%%\arrow[from=2-1, to=2-2]
%%\arrow[from=3-1, to=2-2]
...
\end{tikzcd}$
    ...
    \node [black] at (recCen0) {
$\begin{tikzcd}[sep={between origins, \betweenpieces}]
   	\phantom{\blocktwo{0}} && \phantom{\blocktwo{0}} && \blocktwo{0} && \blocktwo{1} && \blocktwo{0} && \phantom{\blocktwo{0}} && \phantom{\blocktwo{0}} \\
   	\phantom{\blocktwo{0}} & \phantom{\blocktwo{0}} & \phantom{\blocktwo{0}} & \blocktwo{0} & \blocktwo{0} & \blocktwo{1} & \blocktwo{1} & \blocktwo{1} & \blocktwo{0} & \phantom{\blocktwo{0}} & \phantom{\blocktwo{0}} & \phantom{\blocktwo{0}} & \phantom{\blocktwo{0}} \\
   	\phantom{\blocktwo{0}} && \phantom{\blocktwo{0}} && \blocktwo{1} && \blocktwo{0} && \blocktwo{1} && \phantom{\blocktwo{0}} && \phantom{\blocktwo{0}}
%%   	\arrow[from=2-3, to=2-4]
%%   	\arrow[from=1-1, to=2-2]
%%   	\arrow[from=2-1, to=2-2]
%%   	\arrow[from=3-1, to=2-2]
...
\end{tikzcd}$
        ...
        \node [black] at (recCen0) {
    $\begin{tikzcd}[sep={between origins, \betweenpieces}]
       	\phantom{\blockthree{0}} && \phantom{\blockthree{0}} && \blockthree{0} && \blockthree{1} && \blockthree{0} && \phantom{\blockthree{0}} && \phantom{\blockthree{0}} \\
       	\phantom{\blockthree{0}} & \phantom{\blockthree{0}} & \phantom{\blockthree{0}} & \blockthree{0} & \blockthree{1} & \blockthree{1} & \blockthree{0} & \blockthree{1} & \blockthree{1} & \phantom{\blockthree{0}} & \phantom{\blockthree{0}} & \phantom{\blockthree{0}} & \phantom{\blockthree{0}} \\
       	\phantom{\blockthree{0}} && \phantom{\blockthree{0}} && \blockthree{0} && \blockthree{1} && \blockthree{0} && \phantom{\blockthree{0}} && \phantom{\blockthree{0}}
%%       	\arrow[from=2-3, to=2-4]
%%       	\arrow[from=1-1, to=2-2]
%%       	\arrow[from=2-1, to=2-2]
