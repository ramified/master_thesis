...
$$V_1 \longrightarrow V_2 \qquad \dimvec{d}=(\dim_{\mathbb{C}} V_1, \dim_{\mathbb{C}} V_2) \operatorname{\hat{=}} (\dimvec{d}_1,\dimvec{d}_2)$$
 ...
 $$\Rep_{\dimvec{d}}(Q) = \Hom_{\mathbb{C}}(V_1,V_2)$$
	...
	\end{figure}
 $$\Flag(M) := \mu_{\dimvec{d}}^{-1}(M)= \left\{ \text{(complete) flags of $M$} \right\}$$
\end{frame}
...
$$\Flag_{d}(X)\colon=\left\{ F\colon 0 \subseteq N_1 \subseteq \cdots\subseteq N_d \subseteq M \;\middle|\;\rule{0mm}{3.4mm} N_i \in \Rep(Q) \right\}$$
